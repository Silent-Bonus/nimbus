...
export const ROUTES = {
  ...
  AUTH: {
    ...
    SELF_CARE_SOUNDSCAPE_DETAIL: "/(auth)/self-care/soundscape/detail/[soundscapeSlug]",
    SELF_CARE_SOUNDSCAPE_PLAYER: "/(auth)/self-care/soundscape/player/[soundscapeSlug]",
