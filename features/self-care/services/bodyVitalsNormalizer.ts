...
const DEFAULT_PROFILE_COMPLETION_FIELDS = ["sleep_time", "sleep_duration"];

const DEFAULT_FORMULA_VERSIONS: BodyVitalsFormulaVersions = {
...
const DEFAULT_MEASUREMENTS: BodyVitalsMeasurements = {
  bust_cm: null,
  waist_cm: null,
  high_hip_cm: null,
  low_hip_cm: null,
...
const DEFAULT_BODY_SHAPE: BodyVitalsBodyShape = {
...
const DEFAULT_BANNER: BodyVitalsBanner = {
  show: true,
